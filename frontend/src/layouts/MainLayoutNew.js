          ...
          <div className="flex items-center justify-between py-3 sm:py-4">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4 md:space-x-6">
              ...
              <Link to="/cart" className="relative hover:text-gray-600 p-2 group">
                ...
                {cartItemCount > 0 && (
                  <span className="absolute -top-1 -right-1 bg-red-600 text-white text-xs rounded-full min-w-[20px] h-5 flex items-center justify-center font-bold px-1 shadow-md animate-pulse">
